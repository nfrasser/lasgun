...
fn spooky() -> Scene {
    ...
    let purple = scene.add_phong_material([0.7, 0.6, 1.0], [0.8, 0.8, 0.8], 25);
    let glass = scene.add_refractive_material(purple, 1.5, 0.0);
    ...
    item_group.add_cube([-2.0, 0.1, -3.0], 2.0, glass);
